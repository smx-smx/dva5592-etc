...
"G.DMT"*)		newMode="G.992.1_Annex_A";	encap="G.992.3_Annex_K_ATM" ;;
"G.lite"*)		newMode="G.992.2";		encap="G.992.3_Annex_K_ATM" ;;
"T1.413"*)		newMode="T1.413";		encap="G.992.3_Annex_K_ATM" ;;
"ADSL2+ AnnexM"*)	newMode="G.992.5_Annex_M";	encap="G.992.3_Annex_K_ATM" ;;
"ADSL2+"*)		newMode="G.992.5_Annex_A";	encap="G.992.3_Annex_K_ATM" ;;
"RE-ADSL2"*)		newMode="G.992.3_Annex_L";	encap="G.992.3_Annex_K_ATM" ;;
"ADSL2 AnnexM"*)	newMode="G.992.3_Annex_M";	encap="G.992.3_Annex_K_ATM" ;;
"ADSL2"*)		newMode="G.992.3_Annex_A";	encap="G.992.3_Annex_K_ATM" ;;
"VDSL2"*)		newMode="G.993.2_Annex_A";
case "${_xtmmode%%$NEWLINE*}" in
"ATM"*)		encap="G.993.2_Annex_K_ATM" ;;
"PTM"*)		encap="G.993.2_Annex_K_PTM" ;;
esac
;;
"G.fast"*)		newMode="G.9701";
case "${_xtmmode%%$NEWLINE*}" in
"ATM"*)		encap="G.993.2_Annex_K_ATM" ;;
"PTM"*)		encap="G.993.2_Annex_K_PTM" ;;
esac
