...
[ "${status}" != "Up" ] && echo "ERROR: $alias_name is not UP. Stats is not available"; return
echo
...
FirmwareVersion PowerManagementState SNRMpbus SNRMpbds\
TRELLISds TRELLISus LineNumber UpstreamAttenuation DownstreamAttenuation \
