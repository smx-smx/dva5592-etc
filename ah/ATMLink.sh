...
if [ "$_encap" = "LLC" ]; then
case "$_link" in
"EoA" )	echo "llcsnap_eth"
;;
"IPoA" ) echo "llcsnap_rtip"
;;
"PPPoA" ) echo "llcencaps_ppp"
;;
"CIP" ) echo ""
;;
*)
...
"EoA" ) echo "vcmux_eth"
;;
"IPoA" ) echo "vcmux_ipoa"
;;
"PPPoA" ) echo "vcmux_pppoa"
;;
"CIP" )	echo ""
;;
*)
...
local itf itf_list
if [ "$changedEnable" = "1" -o "$changedDestinationAddress" = "1" ]
then
