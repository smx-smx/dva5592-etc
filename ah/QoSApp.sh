...
"")	alg_mod_name=""
;;
*"$ALG_FTP_PROTO_ID"* )		alg_mod_name="$alg_ftp"
;;
*"$ALG_TFTP_PROTO_ID"* )	alg_mod_name="$alg_tftp"
;;
*"$ALG_PPTP_PROTO_ID"* )	alg_mod_name="$alg_pptp"
;;
*"$ALG_IPSEC_PROTO_ID"* )	alg_mod_name="$alg_ipsec"
;;
*"$ALG_SIP_PROTO_ID"* )		alg_mod_name="$alg_sip"
;;
*"$ALG_H323_PROTO_ID"* )	alg_mod_name="$alg_h323"
;;
