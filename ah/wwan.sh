...
wwan_trdata_align() {
	...
	tval=""
	wwanmodem_get_iccid "tval" && setm="$setm	$sobj.ICCID=$tval"
	tval=""
	wwanmodem_get_msin "tval" && setm="$setm	$sobj.MSIN=$tval"
	tval=""
	wwanmodem_get_imei "tval" && setm="$setm	$sobj.IMEI=$tval	$mobj.Modem.IMEI=$tval"
	tval=""
	wwanmodem_get_revision "tval" && setm="$setm	$mobj.Modem.Revision=$tval"
	cmclient SETEM "$setm"
	eval $1='$oper'
	return 0
}
