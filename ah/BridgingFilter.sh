...
case "$_match2" in
"VendorClassID")   br_dhcp_tag="60"
;;
"ClientID")        br_dhcp_tag="61"
_match_mode="hex"
;;
"UserClassID")     br_dhcp_tag="77"
_match_mode="hex"
;;
*)                 return
;;
